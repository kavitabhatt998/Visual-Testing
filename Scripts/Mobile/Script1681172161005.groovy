...
Mobile.sendKeys(findTestObject('Object Repository/Mobile/android.widget.TextView - This is a test'), 'Demo')

Mobile.verifyElementVisible(findTestObject('Object Repository/Mobile/android.widget.TextView - This is a testDemo'), 0)

Mobile.tap(findTestObject('Object Repository/Mobile/android.widget.Button - Do nothing'), 0)
